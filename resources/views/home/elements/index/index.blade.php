...
<section class="home">
    ...
    <div class="owl-carousel home__bg">
        <div class="item home__cover" data-bg="{{URL::asset('assets/home/img/home/home__bg.jpg')}}"></div>
        <div class="item home__cover" data-bg="{{URL::asset('assets/home/img/home/home__bg2.jpg')}}"></div>
        <div class="item home__cover" data-bg="{{URL::asset('assets/home/img/home/home__bg3.jpg')}}"></div>
        <div class="item home__cover" data-bg="{{URL::asset('assets/home/img/home/home__bg4.jpg')}}"></div>
    </div>
    <!-- end home bg -->
        ...
        <div class="row">
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                <a href="#" class="partner">
                    <img src="{{URL::asset('assets/home/img/partners/themeforest-light-background.png')}}" alt="" class="partner__img">
                </a>
            </div>
            <!-- end partner -->
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                <a href="#" class="partner">
                    <img src="{{URL::asset('assets/home/img/partners/audiojungle-light-background.png')}}" alt="" class="partner__img">
                </a>
            </div>
            <!-- end partner -->
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                <a href="#" class="partner">
                    <img src="{{URL::asset('assets/home/img/partners/codecanyon-light-background.png')}}" alt="" class="partner__img">
                </a>
            </div>
            <!-- end partner -->
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                <a href="#" class="partner">
                    <img src="{{URL::asset('assets/home/img/partners/photodune-light-background.png')}}" alt="" class="partner__img">
                </a>
            </div>
            <!-- end partner -->
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                <a href="#" class="partner">
                    <img src="{{URL::asset('assets/home/img/partners/activeden-light-background.png')}}" alt="" class="partner__img">
                </a>
            </div>
            <!-- end partner -->
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                <a href="#" class="partner">
                    <img src="{{URL::asset('assets/home/img/partners/3docean-light-background.png')}}" alt="" class="partner__img">
                </a>
            </div>
            <!-- end partner -->
        </div>
