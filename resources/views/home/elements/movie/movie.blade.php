<section class="section details">
    <!-- details background -->
    <div class="details__bg" data-bg="{{URL::asset('assets/home/img/home/home__bg.jpg')}}"></div>
                        ...
                        <div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-7">
                            <div class="card__content">
                                <div class="card__wrap">
                                    <span class="card__rate"><i class="icon phpion-ios-star"></i>{{$movie->rating}}</span>
                                </div>

                                <ul class="card__meta">
                                    <li><span>Gatunek:</span>
                                        @foreach($movie->movies_genre as $genre)
                                        <a href="#">{{$genre->name}}</a>
                                            @endforeach
                                    </li>
                                    <li><span>Rok premiery:</span> {{$movie->year}}</li>
                                    <li><span>Czas trwania:</span> {{$movie->duration}} min.</li>
                                    <li><span>Kraj:</span> <a href="#">{{$movie->country}}</a> </li>
                                </ul>
