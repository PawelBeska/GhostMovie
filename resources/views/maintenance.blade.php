...
<!-- page 404 -->
<div class="page-404 section--bg" style="background: url({{URL::asset('assets/home/img/section/section.jpg')}}) center center / cover no-repeat">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="page-404__wrap">
                    <div class="page-404__content">
                        <h1 class="page-404__title">PRZERWA TECHNICZNA</h1>
                        <p class="page-404__text">Przepraszamy, lecz na stronie prowadzone są prace techniczne!</p>
                    </div>
                </div>
            </div>
        </div>
